...
<html lang="<?php language_attributes(); ?>">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url( home_url('/wp-content/themes/customtheme/assets/custom-styles.css')); ?>">
    <!-- add our custom font -->
  </head>
  <body <?php body_class(); ?>>
    <header>
      ...
      <li><a href="http://localhost/WinterPHP/view-books-here/">View My Books</a></li>
   </ul>
      </nav>
    </header>